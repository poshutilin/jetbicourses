...
sap.ui.define([
	...
	return BaseController.extend("zjblessons.Market.controller.Object", {
		...
		onPressSave: function() {
			...
			this.getModel("objectView").setProperty("/newMaterial", Object.assign({}, oMaterial));
		...
		onPressReset: function() {
			this.getModel("objectView").setProperty("/editMode", false);
			var oNewMaterial = this.getModel("objectView").getProperty("/newMaterial");
			this.getModel("json").setData(oNewMaterial);
		},
